...
{
    public class StatusEffectReplicateStackable : StatusEffectState
        //use this for Replicate cards that can be doublestacked
    {
        public static StatusEffectData data;
        public const string statusID = "status_replicatestackable";
        ...
        public static void Build()
        {
            ...
            {
                StatusEffectStateType = typeof(StatusEffectReplicateStackable),
                StatusID = statusID,
                IsStackable = true,
